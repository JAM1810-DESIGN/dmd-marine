...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-2xl bg-card py-(--card-spacing) text-sm text-card-foreground shadow-[0_1px_2px_rgba(11,37,69,0.04),0_1px_3px_rgba(11,37,69,0.06)] ring-1 ring-foreground/[0.06] [--card-spacing:--spacing(5)] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(3)] data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-2xl *:[img:last-child]:rounded-b-2xl",
        interactive &&
          "transition-[transform,box-shadow,--tw-ring-color] duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_10px_rgba(11,37,69,0.07),0_2px_4px_rgba(11,37,69,0.06)] hover:ring-foreground/[0.1]",
        className
      )}
      {...props}
    />
